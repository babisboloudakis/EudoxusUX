        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus">
                        <h2 class="aboutus-title">Πληροφοριες Εκδοτων</h2>
                        ...
                        <div class="feature-box">
                            <div class="clearfix">
                                ...
                                <div class="feature-content">
                                    <h4>Καταχώριση Συγγραμάτων</h4>
                                    <p>Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, <a href=/publish.php>Καταχώριση Συγγραμάτος</a>, eleifend ac, enim. Aliquam lorem ante, dapibus in.</p>
                                </div>
                            </div>
                        </div>
                        <div class="feature-box">
                            <div class="clearfix">
                                ...
                                <div class="feature-content">
                                    <h4>Επισκόπιση Συγγραμάτων</h4>
                                    <p>Donec vitae sapien ut libero venenatis faucibu. Nullam quis ante. Etiam <a href=/bookmanagement.php>Επισκόπιση Συγγραμάτων</a> eget eros faucibus tincidunt</p>
                                </div>
                            </div>
                        </div>
                    </div>
